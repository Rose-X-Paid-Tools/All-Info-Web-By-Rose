...
const advancedFeatures = {
  ...
  async processBulkSearch(numbers, type) {
    ...
    const apiUrl = type === 'mobile' ? 
      'https://source-code-api.vercel.app/?num=' :
      'https://number-to-owner.vercel.app/info?name=';
...
const mobileApi = "https://source-code-api.vercel.app/?num=";
const aadhaarApi = "https://number-to-owner.vercel.app/info?name=";
const gstApi = "https://gaurav-osint-panel.gauravyt492.workers.dev/?gstNumber=";
const tgApi = "http://rdxbomb.lovestoblog.com/API.php?username=";
const vehicleApi = "https://new-vehicle-api-eosin.vercel.app/vehicle?rc=";
